...
describe('Dog model', () => {
    ...
    it('tests that null is returned if dogId does not exist in database', async () => {
        const doesNotExistDog = await Dog.findById(100);

        expect(doesNotExistDog).toEqual(null);
    });
